...
Encapsulation is the **principle of restricting direct access to object data** by making instance variables **private** and providing **public methods** (getters & setters) to access or modify them.
